...
ej_pantalla_llegada() {
    ...
    case ${#llegada[*]} in
        ...
        1 )
            ...
            echo -e " Ha llegado el proceso ${estado[enEjecucion]}."
        ;;
...
ej_pantalla_informacion() {
    if [ -n "$algoritmo_srtp" ];then
        echo -e " El proceso SRPT ha dado el valor: $algoritmo_srtp ."
    fi
...
ej_limpiar_eventos() {
    ...
    inicio=""
    salida_ejecucion=""
    algoritmo_srtp="" #ESTO LUEGO LO QUITAS
    salida_memoria=""
